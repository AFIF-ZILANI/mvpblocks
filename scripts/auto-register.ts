...
const REGISTRY_DEPENDENCIES: Record<string, string> = {
  ...
  '@/components/ui/blur-in-text': 'https://blocks.mvp-subha.me/r/blur-in-text.json',
  ...
  '@/components/ui/fade-in-up-text': 'https://blocks.mvp-subha.me/r/fade-in-up-text.json',
  ...
  '@/components/ui/glitch-text': 'https://blocks.mvp-subha.me/r/glitch-text.json',
  ...
  '@/components/ui/gradient-flow-text': 'https://blocks.mvp-subha.me/r/gradient-flow-text.json',
  ...
  '@/components/ui/LegalHeader': 'https://blocks.mvp-subha.me/r/LegalHeader.json',
  ...
  '@/components/ui/scroll-reveal-text': 'https://blocks.mvp-subha.me/r/scroll-reveal-text.json',
  '@/components/ui/scrollbasedvelocity': 'https://blocks.mvp-subha.me/r/scrollbasedvelocity.json',
  '@/components/ui/ScrollToTop': 'https://blocks.mvp-subha.me/r/ScrollToTop.json',
  ...
  '@/components/ui/shuffle-text': 'https://blocks.mvp-subha.me/r/shuffle-text.json',
  ...
  '@/components/ui/variable-proximity-text': 'https://blocks.mvp-subha.me/r/variable-proximity-text.json',
